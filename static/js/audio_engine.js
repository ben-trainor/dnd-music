window.onload = function() { // Have to wait for page to load before running anything
    ...
    var howlerObjectsHolder = {
        soft_piano: soft_piano = new Howl({
            src: ['../static/demo/music/loop_soft_piano.wav'],
            onplay: function() {
        ...
        town_outside: town_outside = new Howl({
            src: ['../static/demo/music/loop_town_outside.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            volume: 1,
        ...
        soft_harp: soft_harp = new Howl({
            src: ['../static/demo/music/loop_soft_harp.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            volume: 1,
        ...
        phase_1: phase_1 = new Howl({
            src: ['../static/demo/music/loop_phase_1.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            volume: 1,
        ...
        a_terrible_fate: a_terrible_fate = new Howl({
            src: ['../static/demo/music/loop_a_terrible_fate.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            volume: 1,
    ...
    play_icon.src = '../static/img/audio-spectrum-svgrepo-com.svg';
    ...
    var ambiencesHolder = {
        ...
        daytime: daytime = new Howl({
            src: ['../static/demo/ambience/ambience_forest_day.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            loop: true
        ...
        nighttime: nighttime = new Howl({
            src: ['../static/demo/ambience/ambience_forest_night.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            loop: true
        ...
        campfire: campfire = new Howl({
            src: ['../static/demo/ambience/ambience_fire_crackling.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            loop: true
        ...
        rain: rain = new Howl({
            src: ['../static/demo/ambience/ambience_rain.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            loop: true
        ...
        babbling_brook: babbling_brook = new Howl({
            src: ['../static/demo/ambience/ambience_babbling_brook.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            loop: true
        ...
        ocean_shore: ocean_shore = new Howl({
            src: ['../static/demo/ambience/ambience_ocean_shore.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            loop: true
        ...
        waterfall: waterfall = new Howl({
            src: ['../static/demo/ambience/ambience_waterfall.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            loop: true
        ...
        boat_rocking: boat_rocking = new Howl({
            src: ['../static/demo/ambience/ambience_boat_rocking.wav'],
            onplay: function() {
                // console.log("Fading in...");
            },
            loop: true
